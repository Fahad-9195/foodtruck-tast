...
import { CustomerOrderTimeline } from "@/components/composite/customer-order-timeline";
import { RatingStars } from "@/components/design/rating-stars";
import type { PickupOrderItem } from "@/features/orders/api/orders.api";
    ...
    <View style={[styles.card, isCurrent && styles.cardCurrent]}>
      ...
      <View style={styles.actions}>
        ...
        <Pressable style={styles.detailsBtn} onPress={onPressDetails}>
          ...
          <Ionicons name="chevron-back" size={iconSize.sm} color={colors.primaryDark} />
        </Pressable>
      </View>
    </View>
  );
