...
import { AdminDashboardStatCard } from "@/components/admin/admin-dashboard-stat-card";
...
import { getAdminStats, getPendingTrucks, reviewTruck } from "@/features/admin/api/admin.api";
