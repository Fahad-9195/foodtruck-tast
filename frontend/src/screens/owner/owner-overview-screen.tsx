...
import { LoadingSkeleton } from "@/components/base/ui-states";
import { AppButton } from "@/components/buttons";
import { EmptyState } from "@/components/design/empty-state";
import { StatusBadge } from "@/components/design/status-badge";
import { AppContainer } from "@/components/layout/app-container";
import { CustomerMapView, Marker } from "@/components/maps/customer-map-view";
import {
...
} from "@/features/trucks/api/trucks.api";
import { getIncomingOwnerOrders } from "@/features/orders/api/orders.api";
import {
  createOwnerMenuItem,
  deleteOwnerMenuItem,
  getMenuCategories,
...
const styles = StyleSheet.create({
  ...
  availOff: {
    backgroundColor: "rgba(123, 138, 160, 0.12)",
    borderColor: colors.border
  },
  availPillText: {
    fontSize: typography.micro,
